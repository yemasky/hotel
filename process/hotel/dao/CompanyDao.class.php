...
class CompanyDao extends \BaseDao {
    ...
    public function getCompany($conditions, $hashKey = null){
        ...
        $fileid = 'company_id, company_group, company_name, company_address, company_mobile, company_phone, company_fax, company_email, company_longitude, '
                 .'company_latitude, company_country, company_province, company_city, company_town';
