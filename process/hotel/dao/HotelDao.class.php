...
class HotelDao extends \BaseDao {
    ...
    public function getHotelModules($conditions){
        ...
        $fileid = 'hotel_id, modules_id, hotel_modules_father_id, hotel_modules_name, hotel_modules_order, hotel_modules_action_permissions, hotel_modules_ico, hotel_modules_show';
