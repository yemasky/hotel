        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <%section name=i loop=$arrayData%>
                    <div class="control-group">
                        ...
                        <%section name=j loop=$arrayData[i].children%>
                            <input type="text" class="span1" value="<%$arrayData[i].childen[j].hotel_service_name%>" name="<%$arrayData[i].childen[j].hotel_service_id%>" />
                        <%/section%>
                        </div>
                    </div>
                <%/section%>
                <div class="controls">
                    ...
                    <a href="#modal_update" class="btn btn-primary btn-mini" data-toggle="modal"><i class="icon-wrench"></i> <%$arrayLaguage['edit_accessorial_service']['page_laguage_value']%></a>
                    <%/if%>
                </div>
